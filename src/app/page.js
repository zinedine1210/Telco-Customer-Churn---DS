    ...
    <div className="page-container">
      ...
      <section className="home-hero">
        ...
        <p className="home-subtitle">
          Analisis data pelanggan telekomunikasi secara cerdas menggunakan machine learning.
      ...
      <section className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-label">Akurasi Model AI</div>
      ...
      <section className="features-section">
        ...
        <p className="section-subtitle">
          Sistem prediksi churn yang powerful untuk membantu keputusan bisnis Anda
        </p>
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            <div className="feature-card-icon">💡</div>
            <h3 className="feature-card-title">Rekomendasi Cerdas</h3>
            <p className="feature-card-desc">
